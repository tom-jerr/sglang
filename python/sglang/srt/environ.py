...
class Envs:
    ...
    SGLANG_EAGLE_KV_ALIGN_MODE = EnvStr("rerun_k")
    SGLANG_EAGLE_KV_ALIGN_COMPARE = EnvBool(False)
    SGLANG_EAGLE_KV_ALIGN_COMPARE_TOPK = EnvInt(5)
    SGLANG_COLLECT_SPEC_ACCEPT_LENGTH_TRACE = EnvBool(False)
